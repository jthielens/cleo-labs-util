...
public class LDAPTest {
	...
	public void test() throws Exception {
		LDAP ldap = new LDAP("ldap(apache,starttls,default,user=cn,mail=mail,name=displayName)://alice:cleo@192.168.50.120:389 2/ou=people,dc=cleo,dc=demo?(objectClass=inetOrgPerson)");
